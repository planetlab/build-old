...
nodeupdate-GITPATH              := git://git.planet-lab.org/nodeupdate.git@NodeUpdate-0.5-5
PingOfDeath-SVNPATH		:= http://svn.planet-lab.org/svn/PingOfDeath/tags/PingOfDeath-2.2-1
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-1.8-25
...
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi@plcapi-4.3-35
drupal-SVNPATH			:= http://svn.planet-lab.org/svn/drupal/tags/drupal-4.7-14
plewww-GITPATH                  := git://git.planet-lab.org/plewww@plewww-4.3-41
...
bootmanager-GITPATH             := git://git.planet-lab.org/bootmanager.git@bootmanager-4.3-15
pypcilib-SVNPATH		:= http://svn.planet-lab.org/svn/pypcilib/tags/pypcilib-0.2-9
bootcd-GITPATH                  := git://git.planet-lab.org/bootcd.git@bootcd-4.2-16
vserver-reference-GITPATH        := git://git.planet-lab.org/vserver-reference.git@vserver-reference-4.2-16
bootstrapfs-GITPATH             := git://git.planet-lab.org/bootstrapfs.git@BootstrapFS-1.0-10
myplc-GITPATH                   := git://git.planet-lab.org/myplc.git@myplc-4.3-36
