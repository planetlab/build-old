...
linux-2.6-GITPATH               := git://git.onelab.eu/linux-2.6.git@linux-2.6-32-21
...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.0-32
...
###
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-1.0-23
...
bootmanager-GITPATH             := git://git.onelab.eu/bootmanager.git@bootmanager-5.0-18
...
bootstrapfs-GITPATH             := git://git.onelab.eu/bootstrapfs.git@bootstrapfs-2.0-11
