...
###
linux-2.6-GITPATH               := git://git.onelab.eu/linux-2.6.git@linux-2.6-27-38
madwifi-GITPATH                 := git://git.onelab.eu/madwifi.git@madwifi-4132-3
...
###
ipfw-GITPATH                    := git://git.onelab.eu/ipfw.git@ipfw-0.9-22
###
...
vsys-scripts-GITPATH            := git://git.onelab.eu/vsys-scripts.git@vsys-scripts-0.95-32
...
plewww-GITPATH                  := git://git.onelab.eu/plewww.git@plewww-4.3-67
...
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-1.0-36
sface-GITPATH                   := git://git.onelab.eu/sface.git@sface-0.1-19
...
tests-GITPATH                   := git://git.onelab.eu/tests.git@tests-5.0-29
