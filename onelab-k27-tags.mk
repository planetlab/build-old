...
###
linux-2.6-GITPATH		:= git://git.onelab.eu/linux-2.6.git@linux-2.6-27-26
...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.0-18
...
plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-5.0-17
...
tests-GITPATH                   := git://git.onelab.eu/tests.git@tests-5.0-15
