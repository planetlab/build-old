...
###
linux-2.6-GITPATH		:= git://git.onelab.eu/linux-2.6.git@linux-2.6-27-27
...
util-vserver-pl-GITPATH		:= git://git.onelab.eu/util-vserver-pl.git@util-vserver-pl-0.4-19
...
plewww-GITPATH                  := git://git.onelab.eu/plewww.git@plewww-4.3-51
...
###
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-1.0-1
sface-GITPATH                   := git://git.onelab.eu/sface.git@sface-0.1-2
...
myplc-GITPATH                   := git://git.onelab.eu/myplc.git@myplc-5.0-10
DistributedRateLimiting-SVNPATH	:= http://svn.planet-lab.org/svn/DistributedRateLimiting/tags/DistributedRateLimiting-0.1-1

# locating the right test directory - see make tests_gitpath
tests-GITPATH                   := git://git.onelab.eu/tests.git@tests-5.0-18
