...
###
linux-2.6-GITPATH		:= git://git.onelab.eu/linux-2.6.git@linux-2.6-27-32
madwifi-SVNPATH			:= http://svn.planet-lab.org/svn/madwifi/tags/madwifi-4132-1
...
###
ipfw-GITPATH			:= git://git.onelab.eu/ipfw@ipfw-0.9-18
###
...
util-vserver-GITPATH		:= git://git.onelab.eu/util-vserver.git@util-vserver-0.30.216-9
...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.0-23
...
plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-5.0-23
drupal-SVNPATH			:= http://svn.planet-lab.org/svn/drupal/tags/drupal-4.7-14
plewww-GITPATH                  := git://git.onelab.eu/plewww.git@plewww-4.3-56
www-register-wizard-SVNPATH     := http://svn.planet-lab.org/svn/www-register-wizard/tags/www-register-wizard-4.3-5
pcucontrol-GITPATH              := git://git.onelab.eu/pcucontrol.git@pcucontrol-1.0-9
