...
NodeManager-SVNPATH             := http://svn.planet-lab.org/svn/NodeManager/tags/NodeManager-2.0-3
...
PLCAPI-SVNPATH                  := http://svn.planet-lab.org/svn/PLCAPI/tags/PLCAPI-5.0-4
...
pyaspects-SVNPATH               := http://svn.planet-lab.org/svn/pyaspects/trunk
...
MyPLC-SVNPATH                   := http://svn.planet-lab.org/svn/MyPLC/tags/MyPLC-5.0-2

# locating the right test directory - see make tests_svnpath
tests-SVNPATH                   := http://svn.planet-lab.org/svn/tests/tags/tests-5.0-3
