...
###
linux-2.6-GITPATH		:= git://git.onelab.eu/linux-2.6.git@linux-2.6-27-20
...
util-vserver-GITPATH		:= git://git.onelab.eu/util-vserver.git@util-vserver-0.30.216-6
libnl-SVNPATH			:= http://svn.planet-lab.org/svn/libnl/tags/libnl-1.1-2
# as per http://svn.planet-lab.org/changeset/17973, 2.6.22 kernels shall use 0.3 branch and 2.6.27 need 0.4 (trunk).
util-vserver-pl-GITPATH		:= git://git.onelab.eu/util-vserver-pl.git@util-vserver-pl-0.4-18
...
bootmanager-GITPATH             := git://git.onelab.eu/bootmanager.git@bootmanager-5.0-10
