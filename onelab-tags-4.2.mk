...
linux-2.6-SVNPATH		:= http://svn.planet-lab.org/svn/linux-2.6/tags/linux-2.6-22-36
...
NodeManager-SVNPATH		:= http://svn.planet-lab.org/svn/NodeManager/tags/NodeManager-1.7-47
pyplnet-SVNBRANCH		:= 4.2
pyplnet-SVNPATH			:= http://svn.planet-lab.org/svn/pyplnet/tags/pyplnet-4.2-3
...
Mom-SVNBRANCH			:= 2.2
Mom-SVNPATH			:= http://svn.planet-lab.org/svn/Mom/tags/Mom-2.2-8
...
vsys-scripts-SVNPATH	:= http://svn.planet-lab.org/svn/vsys-scripts/tags/vsys-scripts-0.9-2
dummynet_image-SVNPATH		:= http://svn.planet-lab.org/svn/dummynet_image/tags/dummynet_image-1.0-4
PLCAPI-SVNBRANCH		:= dummynet
PLCAPI-SVNPATH			:= http://svn.planet-lab.org/svn/PLCAPI/tags/PLCAPI-dummynet-16
PLCWWW-SVNBRANCH		:= onelab.4.2
PLCWWW-SVNPATH			:= http://svn.planet-lab.org/svn/PLCWWW/tags/PLCWWW-onelab.4.2-25
Monitor-SVNBRANCH		:= 1.0
Monitor-SVNPATH			:= http://svn.planet-lab.org/svn/Monitor/tags/Monitor-1.0-16
nodeconfig-SVNBRANCH		:= 4.2
nodeconfig-SVNPATH		:= http://svn.planet-lab.org/svn/nodeconfig/tags/nodeconfig-4.2-17
BootManager-SVNBRANCH		:= 3.2
BootManager-SVNPATH		:= http://svn.planet-lab.org/svn/BootManager/tags/BootManager-3.2-18
...
MyPLC-SVNBRANCH			:= 4.2
MyPLC-SVNPATH                   := http://svn.planet-lab.org/svn/MyPLC/tags/MyPLC-4.2-20
# locating the right test directory - see make testsvnpath
TESTS_SVNPATH			:= http://svn.planet-lab.org/svn/tests/tags/tests-4.2-12
