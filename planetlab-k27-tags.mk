...
linux-2.6-GITPATH		:= git://git.planet-lab.org/linux-2.6.git@linux-2.6-27-32
...
util-vserver-GITPATH		:= git://git.planet-lab.org/util-vserver.git@util-vserver-0.30.216-9
...
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi@plcapi-5.0-23
drupal-SVNPATH			:= http://svn.planet-lab.org/svn/drupal/tags/drupal-4.7-14
plewww-GITPATH			:= git://git.planet-lab.org/plewww@plewww-4.3-56
...
###
sfa-GITPATH			:= git://git.planet-lab.org/sfa.git@sfa-1.0-9
