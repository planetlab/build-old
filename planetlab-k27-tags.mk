...
iptables-GITPATH                := git://git.planet-lab.org/iptables.git@iptables-1.4.10-1
...
bootstrapfs-GITPATH             := git://git.planet-lab.org/bootstrapfs.git@bootstrapfs-2.0-8
myplc-GITPATH                   := git://git.planet-lab.org/myplc.git@myplc-5.0-14
# locating the right test directory - see make tests_gitpath
tests-GITPATH                   := git://git.planet-lab.org/tests.git@tests-5.0-22
