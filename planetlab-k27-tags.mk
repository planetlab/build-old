...
linux-2.6-GITPATH		:= git://git.planet-lab.org/linux-2.6.git@linux-2.6-27-26
...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-2.0-18
...
plewww-GITPATH			:= git://git.planet-lab.org/plewww@plewww-4.3-50
...
###
sfa-SVNPATH			:= http://svn.planet-lab.org/svn/sfa/tags/sfa-0.9-17
...
tests-GITPATH                   := git://git.planet-lab.org/tests.git@tests-5.0-15
