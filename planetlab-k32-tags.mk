...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-2.0-30
...
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi@plcapi-5.0-31
...
bootcd-GITPATH                  := git://git.planet-lab.org/bootcd.git@bootcd-5.0-9
...
myplc-GITPATH                   := git://git.planet-lab.org/myplc.git@myplc-5.0-16
# locating the right test directory - see make tests_gitpath
tests-GITPATH                   := git://git.planet-lab.org/tests.git@tests-5.0-24
