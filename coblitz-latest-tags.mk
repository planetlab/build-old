...
bootmanager-GITPATH		:= git://git.planet-lab.org/bootmanager@BootmMnager-4.3-19
pypcilib-GITPATH                := git://git.planet-lab.org/pypcilib.git@pypcilib-0.2-9
bootcd-GITPATH                  := git://git.planet-lab.org/bootcd.git@bootcd-4.2-17
vserver-reference-GITPATH	:= git://git.planet-lab.org/vserver-reference@VserverReference-5.0-5
