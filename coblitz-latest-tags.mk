...
linux-2.6-GITPATH               := git://git.planet-lab.org/linux-2.6.git@linux-2.6-32-14
...
util-vserver-pl-GITPATH         := git://git.planet-lab.org/util-vserver-pl.git@util-vserver-pl-0.4-24
libnl-SVNPATH			:= http://svn.planet-lab.org/svn/libnl/tags/libnl-1.1-2
nodeupdate-GITPATH		:= git://git.planet-lab.org/nodeupdate.git@nodeupdate-0.5-8
PingOfDeath-SVNPATH		:= http://svn.planet-lab.org/svn/PingOfDeath/tags/PingOfDeath-2.2-1
nodemanager-GITPATH		:= git://git.planet-lab.org/nodemanager@nodemanager-1.8-36
pyplnet-GITPATH                 := git://git.planet-lab.org/pyplnet@pyplnet-4.3-9
...
plcapi-GITPATH			:= git://git.planet-lab.org/plcapi@plcapi-4.3-37
...
nodeconfig-GITPATH              := git://git.planet-lab.org/nodeconfig.git@nodeconfig-4.3-9
bootmanager-BRANCH		:= 4.3
bootmanager-GITPATH		:= git://git.planet-lab.org/bootmanager@bootmanager-4.3-24
pypcilib-GITPATH                := git://git.planet-lab.org/pypcilib.git@pypcilib-0.2-10
bootcd-GITPATH                  := git://git.planet-lab.org/bootcd.git@bootcd-4.2-24
vserver-reference-GITPATH	:= git://git.planet-lab.org/vserver-reference@vserver-reference-4.2-18
bootstrapfs-GITPATH             := git://git.planet-lab.org/bootstrapfs.git@BootstrapFS-1.0-12
myplc-GITPATH                   := git://git.planet-lab.org/myplc@myplc-4.3-46
