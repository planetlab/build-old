...
linux-2.6-GITPATH               := git://git.planet-lab.org/linux-2.6.git@linux-2.6-32-13
...
nodemanager-GITPATH		:= git://git.planet-lab.org/nodemanager@nodemanager-1.8-34
...
nodeconfig-GITPATH              := git://git.planet-lab.org/nodeconfig.git@nodeconfig-4.3-8
bootmanager-BRANCH		:= 4.3
bootmanager-GITPATH		:= git://git.planet-lab.org/bootmanager@bootmanager-4.3-22
pypcilib-GITPATH                := git://git.planet-lab.org/pypcilib.git@pypcilib-0.2-10
bootcd-GITPATH                  := git://git.planet-lab.org/bootcd.git@bootcd-4.2-22
...
myplc-GITPATH                   := git://git.planet-lab.org/myplc@myplc-4.3-44
